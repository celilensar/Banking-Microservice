...
@OpenAPIDefinition(
		info = @Info(
				...
				description = "HepsiJet Cards microservice REST API Documentation",
				version = "v1",
				contact = @Contact(
						name = "Madan Reddy",
						email = "tutor@celilensar.com",
		...
		externalDocs = @ExternalDocumentation(
				description = "HepsiJet Cards microservice REST API Documentation",
				url = "https://www.celilensar.com/swagger-ui.html"
		)
)
